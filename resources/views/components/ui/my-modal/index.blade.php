...
<div x-show="showModal"
     id="modalWindow"
        {{$attributes->class(['hidden fixed z-9999 inset-0 bg-gray-900 bg-opacity-80 overflow-y-auto h-full w-full px-4'])}}>
    <div class="relative top-10 mx-auto max-w-[1800px] shadow-xl bg-white h-[90%] dark:bg-gray-700">
        ...
        @isset($body)
            <div {{$body->attributes->class(['h-[90%] overflow-y-scroll my-4'])}}>{{$body}}</div>
        @endisset
